...
//!
//! [`TransportKind`] is re-exported from [`axon_tool_protocol`] so the wire
...
use axon_tool_protocol::{SessionId, ToolId, UserId};
use axon_tool_runtime::{ToolCallContext, ToolError, ToolStream, TypedToolOutput};

pub use axon_tool_protocol::TransportKind;
