...
fn map_block(block: axon_tool_protocol::McpBlock) -> ContentBlock {
    use axon_tool_protocol::McpBlock;
    match block {
...
pub fn error_from_envelope(err: axon_tool_protocol::JsonRpcError) -> ToolError {
