...
pub struct ToolCallResult {
    ...
    /// this crate must not depend on `axon-tool-runtime`. Sampler-side wire
...
/// `axon_computer_hub_core::registry::ToolSessionBindOutcome`, with one
...
pub struct ToolsListResult {
    pub tools: Vec<axon_tool_types::ToolDescription>,
}
