...
use axon_shell::tools::TodoStatus;
    ...
    let mut lines: Vec<Line<'static>> = todos
        ...
        .map(|t| {
            let (glyph, style) = match t.status {
                ...
                TodoStatus::Completed => (axon_pager::glyphs::check_mark(), theme.muted()),
                TodoStatus::Cancelled => (
                    axon_pager::glyphs::ballot_x(),
...
mod tests {
    ...
    use axon_shell::tools::{TodoItem, TodoPriority};
