...
// its wire types live in `axon_workspace_types::rpc::fs` (the `ClientFs*`
...
pub use axon_workspace_types::rpc::fs::FsReadEncoding;
...
pub use axon_workspace_types::rpc::search::{ClientId, ContentSearchRequest, TargetClientId};
