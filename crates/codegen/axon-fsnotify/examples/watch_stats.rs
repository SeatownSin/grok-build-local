...
//! GROK_FSNOTIFY_PER_DIR=0 cargo run --release -p axon-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! GROK_FSNOTIFY_PER_DIR=1 cargo run --release -p axon-fsnotify --example watch_stats -- run /tmp/js-repo 5
//! ```
//!
