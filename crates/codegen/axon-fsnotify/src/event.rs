//! Public event types — the wire contract for `axon-fsnotify`.
//!
...
//! translator (in `axon-workspace`) maps these to
...
/// Aligned with `axon_workspace_types::FsEventKind` (identity map at
