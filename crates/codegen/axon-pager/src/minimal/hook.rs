...
//! render mode.
//!
//! `axon-pager` cannot depend on `axon-pager-minimal`: that crate reads
...
//!
//! The composition-root binary (`axon-pager-bin`) wires it up once at
//! startup by calling `axon_pager_minimal::install()`. When nothing has
