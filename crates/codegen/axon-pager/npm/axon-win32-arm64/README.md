# @axon-official/axon-win32-arm64

Platform-specific binary for [`@axon-official/axon`](https://www.npmjs.com/package/@axon-official/axon) on win32-arm64.

Do not install this package directly. Install the main package instead:

```sh
npm install -g @axon-official/axon
```
