...
//!
//! Run with: cargo test -p axon-mcp --test repro_sse_flood -- --nocapture
...
use axon_mcp::mcp_http_client::{McpHttpClient, WarnBudget};
use axon_mcp::rmcp::ServiceExt;
use axon_mcp::rmcp::transport::StreamableHttpClientTransport;
use axon_mcp::rmcp::transport::streamable_http_client::StreamableHttpClientTransportConfig;
