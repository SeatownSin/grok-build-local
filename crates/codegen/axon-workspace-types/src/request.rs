...
//!   here would force every consumer of `axon-workspace-types`
...
//! (`axon-workspace`) wraps this in its own `Request<T>` that
//! adds the cancellation token and extensions map.
//!
//! Splitting the envelope this way keeps `axon-workspace-types`
