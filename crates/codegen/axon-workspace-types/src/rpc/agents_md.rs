...
/// Claude.md / `.axon/rules/*.md`) discovered from the workspace root up to
/// the git root, plus `~/.axon` and compat dirs.
...
/// Mirrors the serde shape of `axon-agent`'s `AgentConfigFile`.
