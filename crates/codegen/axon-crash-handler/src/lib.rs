...
//! }
//!
//! axon_crash_handler::install(axon_crash_handler::CrashHandlerConfig {
...
/// `$AXON_HOME` they must not be world-readable.
...
mod tests {
    ...
    fn check_previous_crash_returns_none_when_no_file() {
        let dir = PathBuf::from("/tmp/axon-crash-handler-test-nonexistent");
