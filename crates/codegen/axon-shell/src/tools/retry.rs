//! Retry utilities — re-exported from `axon-tools`.
//!
//! The canonical implementation now lives in `axon_tools::retry`.
//! This module re-exports with backward-compatible aliases.

pub use axon_tools::retry::BackoffConfig as RetryConfig;
pub use axon_tools::retry::{BackoffConfig, execute_with_backoff};
