...
pub const ENV_SHOW_THINKING_BLOCKS: &str = "AXON_SHOW_THINKING_BLOCKS";
...
///
/// Precedence: requirements > env (`AXON_SHOW_THINKING_BLOCKS`) >
...
pub const ENV_GROUP_TOOL_VERBS: &str = "AXON_GROUP_TOOL_VERBS";
...
///
/// Precedence: requirements > env (`AXON_GROUP_TOOL_VERBS`) >
...
pub const ENV_COLLAPSED_EDIT_BLOCKS: &str = "AXON_COLLAPSED_EDIT_BLOCKS";
...
///
/// Precedence: requirements > env (`AXON_COLLAPSED_EDIT_BLOCKS`) >
...
///
/// Precedence: `AXON_MOUSE_REPORTING_TOGGLE` env > `[ui] mouse_reporting_toggle`
...
pub fn resolve_mouse_reporting_toggle(
    ...
    BoolFlag::env("AXON_MOUSE_REPORTING_TOGGLE")
...
mod tests {
    ...
    // Assumes AXON_MOUSE_REPORTING_TOGGLE is unset in the test env.
    #[test]
