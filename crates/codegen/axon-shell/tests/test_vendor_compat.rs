...
fn seed_fixtures(home: &Path, cwd: &Path) {
    ...
    write_skill(home, ".axon", "grok-skill", MARKER_GROK_SKILL);
...
/// `AXON_CURSOR_SKILLS_ENABLED=false` drops the cursor-vendor skill; grok stays.
#[tokio::test]
#[ignore] // requires pre-built binary
...
/// `AXON_CLAUDE_SKILLS_ENABLED=false` drops the claude-vendor skill; grok stays.
#[tokio::test]
#[ignore] // requires pre-built binary
